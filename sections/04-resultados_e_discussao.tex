...
\begin{tabular}{lccc}
\hline
Molécula & $E_{\text{FCI}}$ (Ha) & $E_{\text{VQE}}$ (Ha) & Erro Absoluto (Ha) \\
\hline
...
$E_{\text{VQE}} = -1.1373$ Hartree, enquanto o valor de referência
calculado via diagonalização exata (FCI) foi
$E_{\text{FCI}} = -1.1379$ Hartree, resultando em erro absoluto
da ordem de $6.0 \times 10^{-4}$ Hartree, correspondente a um erro
relativo inferior a 0,1\%.
...
\begin{figure}[H] 
\centering 
\includegraphics[width=0.4\textwidth]{img/h2_convergence.png} 
...
$E_{\text{VQE}} = -7.9576$ Hartree, enquanto o valor de referência
calculado por diagonalização exata foi 
$E_{\text{FCI}} = -8.8745$ Hartree, resultando em erro absoluto
da ordem de $9.17 \times 10^{-1}$ Hartree, aproximadamente 10,3\%
em termos relativos.
...
\begin{figure}[H] 
\centering 
\includegraphics[width=0.4\textwidth]{img/lih_convergence.png} 
\caption{Convergência da energia variacional ao 
...
hardware-efficient adotado, embora adequado para o regime NISQ
